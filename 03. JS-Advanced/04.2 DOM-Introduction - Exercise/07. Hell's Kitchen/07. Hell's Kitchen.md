...
•	Display the **best restaurant** of all the **added restaurants** with its **average salary** and **best salary**. </br>
•	If there is a restaurant in the input array that is added more than once, you need to add new workers to the old ones and **update** the values of the **average salary** and the **best salary**. </br>
•	The best restaurant is the restaurant with the **highest average** salary. If two restaurants have the **same** average salary the best restaurant is the **first** one added. </br>
...
**Output** </br>
•	The output contains **two strings** </br>
...
o	The second one is all the workers in that restaurant in the following format: </br>
