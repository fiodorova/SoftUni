...
&emsp; **•	add(element)** - adds a new element to the collection </br>
&emsp; **•	remove(index)** - removes the element at position **index** </br>
&emsp; **•	get(index)** - returns the value of the element at position **index** </br>
&emsp; **•	size** - number of elements stored in the collection
