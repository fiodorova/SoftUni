...
Write a program that receives a **worker** object as a parameter and modifies its properties. Workers have the following structure: </br>
&emsp; **{ </br>
  &emsp; &emsp; weight: Number, </br>
  &emsp; &emsp; experience: Number, </br>
  &emsp; &emsp; levelOfHydrated: Number, </br>
  &emsp; &emsp; dizziness: Boolean </br>
&emsp; }**
