...
The **input** comes as **three arguments**: </br>
&emsp; •	An **array of strings**, representing pie flavors </br>
&emsp; •	**Two more strings**, representing the start and end of the section, respectively
