...
**Constraints** </br> 
&emsp; ·	The **base** will always be an integer greater than zero </br> 
&emsp; ·	The **increment** will always be a number greater than zero </br> 
&emsp; ·	**Number.MAX_SAFE_INTEGER** will **never be exceeded** for any of the calculations
