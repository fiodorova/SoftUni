...
Your program needs to keep track of how much concrete is used **daily** until the completion of the entire wall. In the end, print on a single line, separated by comma and space, the amount of **concrete** used each **day**, and on a second line, the **final cost** of the wall. One cubic yard of concrete costs **1900** pesos. 
...
**Constraints** </br> 
&emsp; •	The wall may contain up to 2000 sections (2000 elements in the initial array) </br>
&emsp; •	Starting height for each section is within the range [0…30] 
