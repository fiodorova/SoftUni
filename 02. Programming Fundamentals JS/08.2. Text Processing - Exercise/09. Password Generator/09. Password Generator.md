...
&emsp; **'Your generated password is {password}'**
 
<ins>**Note:** All replaced vowels with the characters from the third string must be upper-case, the rest of the characters are lower-case.</ins>
