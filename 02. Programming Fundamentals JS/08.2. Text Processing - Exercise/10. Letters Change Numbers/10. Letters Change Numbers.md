...
**First**, you start with the letter **before** the number: </br>
&emsp; •	If it's **uppercase** you **divide** the number by the letter's **position** in the alphabet </br>
&emsp; •	If it's **lowercase** you **multiply** the number with the letter's **position** in the alphabet

**Then** you move to the **letter after** the number: </br>
&emsp; •	If it's **uppercase** you **subtract** its position from the resulted number </br>
&emsp; •	If it's **lowercase** you **add** its position to the resulted number
...
**For example,** You are given the sequence **"A12b s17G"**: </br>
...
**Constraints** </br>
&emsp; •	The **count** of the strings will be in the range **[1 … 10]**. </br>
&emsp; •	The numbers between the letters will be integers in the range **[1 … 2 147 483 647]**. </br>
&emsp; •	Time limit: 0.3 sec. Memory limit: 16 MB.
