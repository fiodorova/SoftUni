...
•	If it's **uppercase** you **divide** the number by the letter's **position** in the alphabet </br>
•	If it's **lowercase** you **multiply** the number with the letter's **position** in the alphabet

**Then** you move to the **letter after** the number: </br>
•	If it's **uppercase** you **subtract** its position from the resulted number </br>
...
**Constraints** </br>
•	The **count** of the strings will be in the range **[1 … 10]**. </br>
•	The numbers between the letters will be integers in the range **[1 … 2 147 483 647]**. </br>
